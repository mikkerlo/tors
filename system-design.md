...
- [Evolution of Systems Infrastructure at Google](https://www.youtube.com/watch?v=gCGvneeHbPQ)
...
- [CockroachDB: The Resilient Geo-Distributed SQL Database](https://www.cockroachlabs.com/guides/cockroachdb-the-resilient-geo-distributed-sql-database-sigmod-2020/)
...
- [Architecture](https://logdevice.io/docs/Concepts.html)
...
- [Распределенные транзакции в Yandex Database](https://www.highload.ru/moscow/2019/abstracts/5324)
