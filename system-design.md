...
- [CocroachDB Architecture](https://www.cockroachlabs.com/docs/stable/architecture/overview.html), [Design.md](https://github.com/cockroachdb/cockroach/blob/master/docs/design.md), [CockroachDB: The Resilient Geo-Distributed SQL Database](https://www.cockroachlabs.com/guides/cockroachdb-the-resilient-geo-distributed-sql-database-sigmod-2020/)
